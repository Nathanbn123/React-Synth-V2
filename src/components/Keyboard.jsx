          ...
          <div className="row">
            ...
            <div className="grid-container">
              {this.props.imgSrc.map((instance, i) => (
                <div key={i} className={this.props.keyClassNames[i]}>
                  <img
                    className={this.props.imgClassNames[i][0]}
                    src={require(`../synth art/${instance}.svg`)}
                    alt=""
                  />
                  <img
                    className={this.props.imgClassNames[i][1]}
                    src={require(`../synth art/${instance}push.svg`)}
                    alt=""
                    onClick={() => {
                      this.props.playSound(
                        this.props.defaultKeys.notes1[i],
                        this.props.defaultKeys.speed
                      );
                    }}
                  />
                </div>
              ...
              {this.props.imgSrc.map((instance, i) => (
                <div key={i} className={this.props.keyClassNames[i]}>
                  ...
                  <img
                    ...
                    onClick={() => {
                      this.props.playSound(
                        this.props.defaultKeys.notes2[i],
                        this.props.defaultKeys.speed
                      );
                    }}
                  />
              ...
              {this.props.imgSrc.map((instance, i) => (
                <div key={i} className={this.props.keyClassNames[i]}>
                  ...
                  <img
                    ...
                    onClick={() => {
                      this.props.playSound(
                        this.props.defaultKeys.notes3[i],
                        this.props.defaultKeys.speed
                      );
                    }}
                  />
            ...
            <div className="finalKey">
              ...
              <img
                ...
                onClick={() => {
                  this.props.playSound(
                    this.props.defaultKeys.lastNote[0],
                    this.props.defaultKeys.speed
                  );
                }}
              />
